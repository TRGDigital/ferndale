...
export const siteImages: SiteImageEntry[] = [
  ...
  { src: "https://nuxsbykzkivbjtkhheph.supabase.co/storage/v1/object/public/blog/site/activities/exercise-class.jpg", alt: "Residents enjoying a seated exercise class together in the Ferndale activity room", location: "Activities — hero" },
  { src: "https://nuxsbykzkivbjtkhheph.supabase.co/storage/v1/object/public/blog/site/activities/resident-smiling.jpg", alt: "A Ferndale resident smiling in her armchair in the bright, homely lounge", location: "Activities — weekly timetable photo" },
